      ...
      <div className="py-12">
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">Terms & Conditions</h1>
            <p className="text-base sm:text-lg text-gray-700">Understand the rules for using Replyway and your responsibilities.</p>
          </div>
        </Container>
      </div>
        ...
        <Container>
          <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8">
            ...
            <section className="grid gap-6 text-gray-700 leading-relaxed">
              ...
              <div className="bg-gray-50 border border-gray-100 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Eligibility & Account</h3>
                <p>
