        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Innovation",
                description: "We constantly push boundaries to create solutions that anticipate future needs and challenges.",
                icon: "🚀"
              },
              {
                title: "Collaboration",
                description: "We believe that the best solutions come from working together and sharing diverse perspectives.",
                icon: "🤝"
              },
              {
                title: "Excellence",
                description: "We're committed to delivering the highest quality products and experiences for our users.",
                icon: "⭐"
              },
              {
                title: "User-Centric",
              ...
              {
                title: "Growth",
                description: "We embrace continuous learning and improvement, both as individuals and as a company.",
                icon: "📈"
              }
            ].map((value, index) => (
      ...
      <section className="py-20 bg-white">
        <Container>
          <div ref={teamRef} className="text-center mb-16 opacity-0">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Meet the passionate individuals behind Replyway
            </p>
          </div>
            ...
            {[
              {
                name: "Sarah Johnson",
                role: "CEO & Founder",
                description: "Visionary leader with 15+ years in tech innovation and product development.",
                image: "👩‍💼"
              },
              {
                name: "Michael Chen",
                role: "CTO",
                description: "Expert in AI and machine learning with a passion for scalable architecture.",
                image: "👨‍💻"
              },
              {
                name: "Emily Rodriguez",
                role: "Head of Design",
                description: "Creative director focused on user experience and beautiful, intuitive interfaces.",
                image: "👩‍🎨"
              },
              {
                name: "David Kim",
                role: "VP of Engineering",
                description: "Seasoned engineering leader building robust and scalable systems.",
                image: "👨‍🔧"
              },
              {
                name: "Lisa Thompson",
                role: "Head of Marketing",
                description: "Strategic marketer with expertise in growth and brand development.",
                image: "👩‍💼"
              },
              {
                name: "Alex Morgan",
                role: "Product Manager",
                description: "Product strategist focused on user needs and market opportunities.",
                image: "👨‍💼"
              }
            ].map((member, index) => (
              <div key={index} className="text-center">
                <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center text-3xl">
                  {member.image}
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              <p className="text-lg leading-relaxed mb-6">
                Replyway was born from a simple observation: while technology has made us more connected than ever, 
                true collaboration remains challenging. Teams struggle with fragmented tools, poor user experiences, 
                and solutions that don't adapt to their unique workflows.
              </p>
              
              <p className="text-lg leading-relaxed mb-6">
                Founded in 2023, we set out to create a platform that would revolutionize how teams work together. 
                Our journey began with a small team of passionate engineers, designers, and product experts who shared 
                a common vision: to build tools that don't just connect people, but truly empower them.
              </p>
              
              <p className="text-lg leading-relaxed mb-6">
                Today, Replyway serves thousands of teams worldwide, helping them communicate more effectively, 
                collaborate seamlessly, and achieve their goals faster. We continue to innovate and evolve, 
                always guided by our core mission and the feedback of our amazing community.
              </p>
              
              <p className="text-lg leading-relaxed">
                As we look to the future, we're excited about the possibilities that AI and emerging technologies 
                bring. We're committed to staying at the forefront of innovation while maintaining the human-centered 
                approach that makes our platform special.
              </p>
            </div>
          </div>
        </Container>
