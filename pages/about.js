        ...
        <Container>
          <div className='flex items-center justify-center min-h-[400px] py-16'>
            <div className='max-w-3xl text-center'>
              <h1 ref={heroRef} className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-4 sm:mb-6 opacity-0'>
                About Replyway
              </h1>
      ...
      <section className="pt-12 pb-20 bg-white">
        <Container>
          <div ref={missionRef} className="max-w-4xl mx-auto text-center opacity-0">
            <h2 className="text-3xl sm:text-4xl font-semibold text-gray-900 mb-6">Our Mission</h2>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
        <Container>
          <div ref={valuesRef} className="text-center mb-16 opacity-0">
            <h2 className="text-3xl sm:text-4xl font-semibold text-gray-900 mb-6">Our Values</h2>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-semibold text-gray-900 mb-6">Our Story</h2>
            </div>
